...
//        typeOm = new ExtensionFilter("OpenModelica file(s) (*.om)", "*.om", "*.OM");
    ...
    private boolean SaveFile(ModelDao dao, File file, ExtensionFilter filter) {
...
//            return SaveOm(dao, file);
    ...
    private boolean SaveSbml(ModelDao dao, File file) {
    ...
    public File ShowSaveFile(Stage stage, ModelDao dao) {
...
//        fileChooser.getExtensionFilters().add(typeOm);
    ...
    public void Save() {
        ...
        ModelDao dao = dataService.getDao();
     ...
     */
    public boolean SaveAs(ModelDao dao) {

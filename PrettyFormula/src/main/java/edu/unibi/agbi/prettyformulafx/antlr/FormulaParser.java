...
public class FormulaParser extends Parser {
	...
	public static class ExprContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FormulaVisitor ) return ((FormulaVisitor<? extends T>)visitor).visitExpr(this);
	...
	public static class Neg_numberContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FormulaVisitor ) return ((FormulaVisitor<? extends T>)visitor).visitNeg_number(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class VariableContext extends ParserRuleContext {
		public List<TerminalNode> INDEX() { return getTokens(FormulaParser.INDEX); }
		public TerminalNode VARIABLE() { return getToken(FormulaParser.VARIABLE, 0); }
		public TerminalNode INDEX(int i) {
			return getToken(FormulaParser.INDEX, i);
		}
	...
	public static class Neg_variableContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FormulaVisitor ) return ((FormulaVisitor<? extends T>)visitor).visitNeg_variable(this);
			else return visitor.visitChildren(this);
		}
	}

...
import edu.unibi.agbi.prettyformulafx.antlr.FormulaBaseVisitor;
 ...
 */
public class PrettyFormulaParseRules extends FormulaBaseVisitor<String> {
     ...
     */
    @Override
    public String visitNumber(@NotNull FormulaParser.NumberContext ctx) {
        return ctx.getText();
    }
     ...
     */
    @Override
    public String visitNeg_number(@NotNull FormulaParser.Neg_numberContext ctx) {
     ...
     * subscript part added to it, the subscript part is recursively wrapped in
     * curly braces, so subscript words with length > 1 are possible.
     *
     ...
     */
    @Override
    public String visitVariable(@NotNull FormulaParser.VariableContext ctx) {
     ...
     */
    @Override
    public String visitNeg_variable(@NotNull FormulaParser.Neg_variableContext ctx) {
     ...
     * @return Returns the formula string of the term node (including all its
     * children) formatted according to the rules specified in this function.
     */
    @Override
    public String visitTerm(@NotNull FormulaParser.TermContext ctx)
